...
class TestRNull(TestCase):
    ...
    def tearDownClass(cls):
        ...
        cls.runModule("g.remove", flags="f", type="raster", name=["map_basic", "map_fill_nulls", "map2"])
        cls.del_temp_region()
    ...
    def test_basic(self):
        ...
        expected_output = {'has_nulls': True, 'ranges': [{'min': 2, 'max': 2}, {'min': 3, 'max': 3}]}
    ...
    def test_float_flag(self):
        ...
        expected_output = {'has_nulls': True, 'ranges': [{'min': 2.5, 'max': 2.5019607843137255}, {'min': 2.9980392156862745, 'max': 3}]}
    ...
    def test_fill_nulls(self):
        ...
        category_output = gs.parse_command("r.describe", map="map_fill_nulls", format="json")
